...
seed_wallet_private_key = os.getenv("SEED_WALLET_PRIVATE_KEY")
roots_wallet_private_key = os.getenv("ROOTS_WALLET_PRIVATE_KEY")
fruit_wallet_private_key = os.getenv("FRUIT_WALLET_PRIVATE_KEY")
branches_wallet_private_key = os.getenv("BRANCHES_WALLET_PRIVATE_KEY")
goldstem_contract_address = os.getenv("GOLDSTEM_CONTRACT_ADDRESS")
